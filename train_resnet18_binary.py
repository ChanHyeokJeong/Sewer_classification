...
def build_resnet18(num_classes, fine_tune_layer4):
...
def main():
    ...
    parser.add_argument("--fine_tune_layer4", action="store_true")
    ...
    best_val_f1 = -1.0
    best_model_path = os.path.join(args.output_dir, "best_resnet18_binary.pth")

    print("Device =", device)
    print("Classes =", class_names)
    print("Fine-tune layer4 =", args.fine_tune_layer4)
    ...
    print("\nImageNet-pretrained ResNet18 Classification Result")
    ...
    result_path = os.path.join(args.output_dir, "result_resnet18_binary.txt")

    with open(result_path, "w", encoding="utf-8") as f:
        f.write("ImageNet-pretrained ResNet18 Classification Result\n")
        f.write(f"Classes = {class_names}\n")
        f.write(f"Fine-tune layer4 = {args.fine_tune_layer4}\n\n")
